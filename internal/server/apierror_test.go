...
func TestRequestValidationError_Messages(t *testing.T) {
	...
	cases := []struct {
		...
		{"2020 missing", &openapi3filter.RequestError{RequestBody: body, Err: &openapi3.SchemaError{Reason: `at '': missing property 'status'`}}, `request body: is missing required property 'status'`},
