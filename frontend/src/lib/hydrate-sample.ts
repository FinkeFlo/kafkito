...
/**
 * Hydrates truncated JSON sample messages with their full raw value, so
 ...
 * JSON usually fails to parse). Falls back to the truncated preview on fetch
